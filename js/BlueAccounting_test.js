...
//                }
    ...
    this.buildDualChartSingleAxis = function (series1, seriesName1, color1, chartType1,
                                        series2, seriesName2, color2, chartType2, seriesUnit,
                                        tag, title, subtitle, desc, startingYear, target, cap, height, width, xAxis_title) {
...
//                }
            ...
            yAxis: { // Primary yAxis
                title: {
                    text: seriesUnit ? seriesName1 + "<br>(" + seriesUnit + ")" : seriesName1, 
                    style: {
                        color: color1
                    }
                }
        ...
        if (target) {
            this.addTargetLine(chart, target, seriesName1 + " Target");
        }
